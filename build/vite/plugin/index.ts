...
export function createVitePlugins(viteEnv: ViteEnv, isBuild: boolean, isQiankunMicro: boolean) {
  ...
  // Scan application sources only: local backups and generated bundles are not inputs.
  vitePlugins.push(purgeIcons({ content: ['src/**/*.{vue,html,js,ts,jsx,tsx}', 'index.html'] }));
