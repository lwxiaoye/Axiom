<template>
  <Dropdown placement="bottomLeft" :overlayClassName="`${prefixCls}-dropdown-overlay`">
    <span :class="[prefixCls, `${prefixCls}--${theme}`]" class="flex">
      <img :class="`${prefixCls}__header`" :src="getAvatarUrl" alt="用户头像" @error="handleAvatarError" />
...
<script lang="ts">
  // components
  import { Dropdown, Menu as DropdownMenu } from 'ant-design-vue';
  ...
  type MenuEvent = 'logout' | 'doc' | 'lock' | 'cache' | 'depart' | 'defaultHomePage' | 'password';
  ...
  export default defineComponent({
    ...
    components: {
      ...
      MenuDivider: DropdownMenu.Divider,
    ...
    setup() {
      ...
      const getAvatarUrl = computed(() => {
        if (avatarFailed.value) return headerImg;
