import md5 from 'md5';
// Legacy Java protocol compatibility value. Frontend values are public, not secrets.
const signatureSalt = import.meta.env.VITE_REQUEST_SIGNATURE_SALT || '';
...
export default class signMd5Utils {
  ...
  static getSign(url, requestParams, requestBodyParams) {
    ...
    if (!signatureSalt) {
      throw new Error('请先配置与业务后端一致的请求签名参数');
    }
    return md5(JSON.stringify(requestBody) + signatureSalt).toUpperCase();
  }
