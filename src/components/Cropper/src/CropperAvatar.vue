<template>
  ...
  <CopperModal v-bind="modalProps" @register="register" @upload-success="handleUploadSuccess" :uploadApi="uploadApi" :src="sourceValue" />
  </div>
</template>
<script lang="ts">
  ...
  const props = {
    ...
    modalProps: { type: Object as PropType<Record<string, unknown>>, default: () => ({}) },
