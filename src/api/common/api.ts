...
import { buildUploadActionUrl, getUploadRequestUrl } from '/@/utils/common/uploadUrl';
 ...
 * 上传父路径
 */
export const uploadUrl = buildUploadActionUrl(baseUploadUrl);
...
export const uploadFile = (params, success) => {
  return defHttp.uploadFile({ url: getUploadRequestUrl() }, params, { success });
};
/**
 * 下载文件
 * @param url 文件路径
