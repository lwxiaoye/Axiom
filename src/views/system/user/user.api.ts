...
enum Api {
  ...
  getUserIdentityCard = '/sys/user/queryIdCard',
...
/**
 * 编辑用户时读取证件号；通用用户列表不返回该敏感字段。
 */
export const getUserIdentityCard = (params) => defHttp.get({ url: Api.getUserIdentityCard, params }, { errorMessageMode: 'none' });
